...
subtitle: I discuss fundamental ideas behind fully convolutional networks in an approchable manner, including the transformation of fully connected layers to convolutional layers and upsampling via transposed convolutions ("deconvolutions").
date: 2020-07-07

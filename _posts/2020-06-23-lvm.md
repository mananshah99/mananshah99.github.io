...
subtitle: Latent variable models provide a powerful way to represent complex distributions
...
{% comment %}
{% include callout.html title="callout" content="This is a minimalist callout." type="primary" %} 
{% endcomment %}

It's taken me a while to fully grasp latent variable models, and I hope to use
...
this material are inspired by Stanford's [CS 228](cs228.stanford.edu) and [CS
236](cs236.stanford.edu) courses, taught by Dr. Stefano Ermon.
